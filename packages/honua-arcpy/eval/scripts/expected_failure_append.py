"""Expected-failure script exercising management.Append."""
...
try:
    arcpy.management.Append(['updates'], 'roads', 'NO_TEST')
except arcpy.HonuaArcpyUnsupportedError as exc:
    print(f"expected_failure_append caught {exc.function}")
    raise SystemExit(0) from exc
raise SystemExit("expected_failure_append did not raise")
