"""Expected-failure script exercising analysis.Near."""
...
try:
    arcpy.analysis.Near('points', 'roads')
except arcpy.HonuaArcpyUnsupportedError as exc:
    print(f"expected_failure_near caught {exc.function}")
    raise SystemExit(0) from exc
raise SystemExit("expected_failure_near did not raise")
