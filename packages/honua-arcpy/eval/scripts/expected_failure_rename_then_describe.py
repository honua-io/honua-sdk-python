"""Expected-failure script exercising management.Rename."""
...
try:
    ...
    print(f"expected_failure_rename_then_describe caught {exc.function}")
    raise SystemExit(0) from exc
raise SystemExit("expected_failure_rename_then_describe did not raise")
