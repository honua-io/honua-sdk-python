"""Expected-failure script exercising analysis.Intersect."""
...
try:
    ...
    print(f"expected_failure_intersect_roads_parcels caught {exc.function}")
    raise SystemExit(0) from exc
raise SystemExit("expected_failure_intersect_roads_parcels did not raise")
