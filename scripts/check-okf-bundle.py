...
def main(argv: list[str]) -> int:
    ...
    # check_runbook_typing and check_summary_is_in_bundle are honua-server
    # specific: this repo has no code-referenced anchor registry and no
    # SUMMARY.md. Its entry point is docs/features/README.md (type: index).
