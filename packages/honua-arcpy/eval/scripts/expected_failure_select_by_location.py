"""Expected-failure script exercising management.SelectLayerByLocation."""
...
try:
    arcpy.management.SelectLayerByLocation('roads', 'INTERSECT', 'study_area')
except arcpy.HonuaArcpyUnsupportedError as exc:
    print(f"expected_failure_select_by_location caught {exc.function}")
    raise SystemExit(0) from exc
raise SystemExit("expected_failure_select_by_location did not raise")
