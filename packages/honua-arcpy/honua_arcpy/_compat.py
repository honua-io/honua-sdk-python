...
COMPAT: dict[str, FunctionEntry] = {
    ...
    "management.AddField": FunctionEntry(
        backend="admin",
        status="supported",
        notes="Schema-mutating call; goes through honua_admin manifest apply.",
        param_map={
            "in_table": "resource",
            "field_name": "name",
            "field_type": "type",
    ...
    "management.Rename": FunctionEntry(
        backend="admin",
        status="supported",
        notes="Renames a resource via honua_admin manifest apply.",
        param_map={
            "in_data": "resource",
            "out_data": "new_name",
            "data_type": "data_type",
    ...
    "management.GetCount": FunctionEntry(
        backend="source",
        status="supported",
        notes="Returns a row count using Source.query with return_count_only semantics.",
        param_map={"in_rows": "layer_name"},
    ),
    "management.ListFields": FunctionEntry(
        backend="admin",
        status="supported",
        notes="Returns a list of FieldDescribe entries from the admin layer-schema endpoint.",
        param_map={
            "dataset": "resource",
            "wild_card": "wild_card",
            "field_type": "field_type",
    ...
    "management.Describe": FunctionEntry(
        backend="admin",
        status="supported",
        notes="Returns a Describe object from the admin layer-schema endpoint.",
        param_map={"value": "resource"},
    ),
    # -----------------------------------------------------------------
    # da.* (10)
    # -----------------------------------------------------------------
