"""Expected-failure script exercising analysis.TabulateIntersection."""
...
try:
    arcpy.analysis.TabulateIntersection('a', 'a_id', 'b', 'out')
except arcpy.HonuaArcpyUnsupportedError as exc:
    print(f"expected_failure_tabulate_intersection caught {exc.function}")
    raise SystemExit(0) from exc
raise SystemExit("expected_failure_tabulate_intersection did not raise")
