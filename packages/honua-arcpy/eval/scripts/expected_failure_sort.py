"""Expected-failure script exercising management.Sort."""
...
try:
    arcpy.management.Sort('roads', 'roads_sorted', [['name', 'ASCENDING']])
except arcpy.HonuaArcpyUnsupportedError as exc:
    print(f"expected_failure_sort caught {exc.function}")
    raise SystemExit(0) from exc
raise SystemExit("expected_failure_sort did not raise")
