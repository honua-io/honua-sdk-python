"""Expected-failure script exercising analysis.Erase."""
...
try:
    ...
    print(f"expected_failure_erase_water_from_parcels caught {exc.function}")
    raise SystemExit(0) from exc
raise SystemExit("expected_failure_erase_water_from_parcels did not raise")
