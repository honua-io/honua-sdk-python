...
class GeoServicesImageServerClient(_SyncProtocol):
    ...
    def compute_histograms(
        ...
        *,
        ...
        pixel_size: Mapping[str, Any] | str | None = None,
        ...
        if pixel_size is not None:
            params["pixelSize"] = _query_value(pixel_size)
    ...
    def get_samples(
        ...
        *,
        ...
        mosaic_rule: Mapping[str, Any] | str | None = None,
        pixel_size: Mapping[str, Any] | str | None = None,
        return_first_value_only: bool | None = None,
        interpolation: str | None = None,
        out_fields: CsvValue | None = None,
        response_format: str = "json",
        extra_params: Params = None,
    ) -> JsonObject:
        ...
        if pixel_size is not None:
            params["pixelSize"] = _query_value(pixel_size)
        if return_first_value_only is not None:
            params["returnFirstValueOnly"] = _bool_text(return_first_value_only)
        if interpolation is not None:
            params["interpolation"] = interpolation
        if out_fields is not None:
            params["outFields"] = _csv(out_fields)
        if extra_params:
            params.update(extra_params)
    ...
    def measure(
        ...
        *,
        ...
        measure_operation: str | None = None,
        mosaic_rule: Mapping[str, Any] | str | None = None,
        pixel_size: Mapping[str, Any] | str | None = None,
        ...
        params = _params({"f": response_format, "fromGeometry": _query_value(from_geometry), "geometryType": geometry_type}, None)
    ...
    def project(
        ...
        *,
        ...
        """
        params = _params({"f": response_format, "geometries": _query_value(geometries), "inSR": in_sr, "outSR": out_sr}, extra_params)
