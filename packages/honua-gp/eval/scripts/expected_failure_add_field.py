"""Expected-failure script exercising management.AddField."""
...
try:
    arcpy.management.AddField('segments', 'route_id', field_type='LONG')
except arcpy.HonuaGpUnsupportedError as exc:
    print(f"expected_failure_add_field caught {exc.function}")
    raise SystemExit(0) from exc
raise SystemExit("expected_failure_add_field did not raise")
