"""Expected-failure script exercising management.CreateFeatureclass."""
...
try:
    arcpy.management.CreateFeatureclass('honua://services/transport', 'new_fc', 'POLYGON')
except arcpy.HonuaArcpyUnsupportedError as exc:
    print(f"expected_failure_create_fc caught {exc.function}")
    raise SystemExit(0) from exc
raise SystemExit("expected_failure_create_fc did not raise")
