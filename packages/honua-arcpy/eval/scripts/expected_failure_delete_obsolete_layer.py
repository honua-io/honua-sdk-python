"""Expected-failure script exercising management.Delete."""
...
try:
    ...
    print(f"expected_failure_delete_obsolete_layer caught {exc.function}")
    raise SystemExit(0) from exc
raise SystemExit("expected_failure_delete_obsolete_layer did not raise")
