...
The file path is ``${HONUA_ARCPY_AUDIT_DIR:-./.honua-arcpy/audit}/audit-YYYYMMDD.jsonl``
...
_AUDIT_DIR_ENV = "HONUA_ARCPY_AUDIT_DIR"
_AUDIT_DEFAULT_DIR = Path(".honua-arcpy") / "audit"
