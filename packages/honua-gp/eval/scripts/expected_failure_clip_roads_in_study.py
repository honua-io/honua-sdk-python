"""Expected-failure script exercising analysis.Clip."""
...
try:
    ...
    print(f"expected_failure_clip_roads_in_study caught {exc.function}")
    raise SystemExit(0) from exc
raise SystemExit("expected_failure_clip_roads_in_study did not raise")
