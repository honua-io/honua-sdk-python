"""Expected-failure script exercising management.Project."""
...
try:
    ...
    print(f"expected_failure_project_parcels_then_clip caught {exc.function}")
    raise SystemExit(0) from exc
raise SystemExit("expected_failure_project_parcels_then_clip did not raise")
